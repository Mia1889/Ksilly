...
[![Version](https://img.shields.io/badge/Version-2.0.0-purple)](https://github.com/Mia1889/Ksilly)
[![License](https://img.shields.io/badge/License-MIT-yellow)](LICENSE)

一条命令完成 SillyTavern 的安装、配置、后台运行与更新管理
...
~/.ksilly.conf          # Ksilly 脚本配置（安装路径、网络设置等）
```
